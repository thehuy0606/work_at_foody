...
SELECT  
        f.*
    ,   o.net_order
    ,   1.0000*f.hit_order/o.net_order  percent_rule
FROM        pivot_fgps  f
LEFT JOIN   pivot_ords  o ON f.period_grp = o.period_grp and f.period = o.period and f.days = o.days
ORDER BY 1,2,4
