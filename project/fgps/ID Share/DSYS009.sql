...
, susp AS (
    SELECT 
        ...
        , IF(
            COUNT(
                CASE 
                    WHEN (lead_5_ping_acc_4 - count_acc_4 = 5) 
                        AND b.order_id IS NULL 
                        THEN o.order_id 
                    END
                ) >= 1 
            , TRUE, FALSE) AS repet_acc_4
    FROM susp_1 o
...
SELECT 
    ...
    , repet_acc_4 AS is_109                              -- DSYS109
    , count_repet_acc_4 AS cnt_109                       -- DSYS109
