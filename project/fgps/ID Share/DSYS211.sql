...
, susp AS (
    SELECT 
        ...
        , IF(
            COUNT(
                CASE 
                    WHEN (lead_5_ping_acc_0 - count_acc_0 = 5) 
                        THEN o.order_id 
                END) >= 1 
            , TRUE, FALSE) AS repet_acc_0
    FROM susp_1 o
...
SELECT 
    ...
    , repet_acc_0 AS is_211                              -- DSYS211
    , count_repet_acc_0 AS cnt_211                       -- DSYS211
