...
, susp AS (
    SELECT 
        ...
        , IF(
            COUNT(
                CASE 
                    WHEN (lead_5_ping_acc_7 - count_acc_7 = 5) 
                        THEN o.order_id 
                END) >= 1 
            , TRUE, FALSE) AS repet_acc_7
    FROM susp_1 o
...
SELECT 
    ...
    , repet_acc_7 AS is_213                              -- DSYS213
    , count_repet_acc_7 AS cnt_213                       -- DSYS213
