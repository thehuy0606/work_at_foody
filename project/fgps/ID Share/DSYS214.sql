...
, susp AS (
    SELECT 
        ...
        , IF(
            COUNT(
                CASE 
                    WHEN (lead_5_ping_acc_3 - count_acc_3 = 5) 
                        THEN o.order_id 
                END) >= 1 
            , TRUE, FALSE) AS repet_acc_3
    FROM susp_1 o
...
SELECT 
    ...
    , repet_acc_3 AS is_214                              -- DSYS214
    , count_repet_acc_3 AS cnt_214                       -- DSYS214
